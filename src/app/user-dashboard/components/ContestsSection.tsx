    ...
    <section className="w-full">
      ...
      <div className="rounded-2xl w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Add more contest placeholder */}
          {/* <div className="bg-card rounded-2xl border border-border p-6 flex flex-col items-center justify-center min-h-[300px] border-dashed">
            <div className="text-muted-foreground text-center">
              <Edit3 className="w-12 h-12 mx-auto mb-4 opacity-50" />
              <p className="font-medium mb-2">Start a new contest</p>
              <p className="text-sm">Find more contests to participate in</p>
            </div>
          </div> */}
        </div>
      </div>
