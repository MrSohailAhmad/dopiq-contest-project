...
export const AvailSidebar = () => {
  return (
    <aside className="w-80 sticky-sidebar space-y-6 self-start">
      {/* Balance Card */}
      <div className="bg-gradient-to-br from-blue-500 to-blue-500 rounded-2xl p-6 text-white">
        <div className="mb-4">
          <div className="text-3xl font-bold mb-1">$340</div>
          <div className="text-white/80 font-medium">Available Balance</div>
          <div className="text-sm text-white/70 mt-1">
            Last payment: Aug 15, 2023
          </div>
        </div>
